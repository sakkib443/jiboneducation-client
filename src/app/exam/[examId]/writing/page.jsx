                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                            ...
                            {activePart && (
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '4px 12px', border: `1px solid ${contrastMode === 'black-on-white' ? '#d1d5db' : cs.text}`, borderRadius: '6px' }}>
                                    ...
                                    <span style={{ fontFamily: 'monospace', fontSize: '16px', fontWeight: '700', color: cs.text, minWidth: '52px', textAlign: 'center' }}>{formatTime(currentTime)}</span>
                                </div>
                            )}
                            {/* WiFi */}
